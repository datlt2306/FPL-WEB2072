<template>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <!-- Topbar Header -->
        <header class="h-16 bg-white border-b border-slate-200/80 flex items-center justify-between px-8 flex-shrink-0">
                    ...
                    <table class="w-full text-left text-sm text-slate-600 border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            <tr>
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-3">
                                        <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=100&auto=format&fit=crop&q=80"
                                            alt="product"
                                            class="w-12 h-12 object-cover rounded-lg border border-slate-100 shrink-0" />
                                        <div>
                                            <p class="font-bold text-slate-800 text-sm">Tai Nghe Vanguard Studio
                                                Wireless</p>
                                            <p class="text-xs text-slate-400 line-clamp-1">Công nghệ chống ồn ANC đỉnh
                                                cao...</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 font-extrabold text-slate-800">3.500.000 đ</td>
                                <td class="px-6 py-4 font-semibold text-slate-500">12 chiếc</td>
                            ...
                            <tr>
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-3">
                                        <img src="https://images.unsplash.com/photo-1627124765138-b6b77e815b3c?w=100&auto=format&fit=crop&q=80"
                                            alt="product"
                                            class="w-12 h-12 object-cover rounded-lg border border-slate-100 shrink-0" />
                                        <div>
                                            <p class="font-bold text-slate-800 text-sm">Ví Da Nam Tối Giản Vanguard
                                                Leather</p>
                                            <p class="text-xs text-slate-400 line-clamp-1">Chất liệu da Saffiano thật
                                                100%...</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 font-extrabold text-slate-800">650.000 đ</td>
                                <td class="px-6 py-4 font-semibold text-slate-500">45 chiếc</td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="admin-product-edit.html"
                                            class="p-2 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors"
